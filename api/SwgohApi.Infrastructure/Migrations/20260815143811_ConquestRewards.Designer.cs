...
namespace SwgohApi.Infrastructure.Migrations
{
    ...
    [Migration("20260815143811_ConquestRewards")]
    partial class ConquestRewards
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SwgohApi.Infrastructure.Models.ConquestReward", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<DateOnly>("FinalRewardCreateDate")
                        .HasColumnType("date");

                    b.Property<DateOnly>("InitialUnlockDate")
                        .HasColumnType("date");

                    b.Property<DateOnly>("ProvingGroundsDate")
                        .HasColumnType("date");
                    ...
                    b.ToTable("ConquestRewards", null, t =>
                        {
                            t.HasCheckConstraint("CK_ConquestReward_Entity", "(\n    \"CharacterId\" IS NOT NULL\n    AND\n    \"ShipId\" IS NULL\n)\nOR\n(\n    \"CharacterId\" IS NULL\n    AND\n    \"ShipId\" IS NOT NULL\n)");
                        });
                });
            ...
            modelBuilder.Entity("SwgohApi.Infrastructure.Models.ConquestReward", b =>
                {
                    b.HasOne("SwgohApi.Infrastructure.Models.Character", "Character")
                        .WithOne("ConquestReward")
                        .HasForeignKey("SwgohApi.Infrastructure.Models.ConquestReward", "CharacterId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("SwgohApi.Infrastructure.Models.Ship", "Ship")
                        .WithOne("ConquestReward")
                        .HasForeignKey("SwgohApi.Infrastructure.Models.ConquestReward", "ShipId")
                        .OnDelete(DeleteBehavior.Cascade);
